...
<template>
  <span class="flex flex-col min-h-screen relative text-gray-300 font-sans leading-normal tracking-normal overflow-hidden">
    <main class="relative flex flex-col md:flex-row flex-grow items-center justify-center w-full px-3 sm:px-5 md:px-10 pt-28 pb-24">
      <section class="w-full max-w-md md:max-w-none md:w-1/3 flex flex-col items-center mb-12 md:mb-0 md:mr-10 lg:mr-16">
        <header class="justify-center items-center flex flex-col text-center md:text-left">
          <figure class="brillo-css-sencillo">
            <img
          ...
          <aside class="p-3 bg-gray-900/80 shadow-sm rounded-2xl mt-6">
      ...
      <section
        ...
        <figure class="relative rounded-xl overflow-hidden w-full h-64 sm:h-72 md:h-80 lg:h-96 shadow-inner">
          <Transition :name="`slide-${direction}`">
            <article :key="currentSlide" class="slide-content absolute inset-0 w-full h-full">
              <a :href="sliderImages[currentSlide].linkUrl || '#'" target="_blank" rel="noopener noreferrer"
                ...
                <img
                  ...
                  class="w-full h-full object-cover cursor-pointer rounded-md grayscale group-hover:grayscale-0 transition-all duration-500 group-hover:scale-105" />
              </a>
            </article>
          </Transition>
          ...
          <footer class="absolute bottom-4 left-0 right-0 flex justify-center space-x-3 z-20">
