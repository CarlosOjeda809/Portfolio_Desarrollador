...
const handleMouseOver = (path) => {
  showPreviews.value[path] = true;
};

const handleMouseOut = (path) => {
  showPreviews.value[path] = false;
};
</script>
        ...
        <div class="mt-16 ml-2 divide-y divide-gray-600 w-[full]">
          <div class="relative">
            ...
            <transition name="preview-fade">
              <div v-if="showPreviews['/']"
                ...
                <img src="public\img\menuhover\index.png" alt="Vista previa Inicio" class="rounded">
              </div>
            </transition>
          </div>
          ...
          <div class="relative">
            <a @click="navigateTo('/sobremi')"
              class="block text-white transition duration-500 font-medium hover:-translate-x-2 hover:text-purple-400 cursor-pointer py-3 text-lg"
              @mouseover="handleMouseOver('/sobremi')" @mouseout="handleMouseOut('/sobremi')">Sobre
              Mí</a>
            <transition name="preview-fade">
              <div v-if="showPreviews['/sobremi']"
                class="absolute right-full top-0 mr-10 w-64 bg-gray-800 rounded-md shadow-lg z-50 overflow-hidden">
                <img src="public\img\menuhover\sobremi.png" alt="Vista previa Sobre Mí" class="rounded">
              </div>
            </transition>
          </div>
          ...
          <div class="relative">
            <a @click="navigateTo('/skills')"
              class="block text-white transition duration-500 font-medium hover:-translate-x-2 hover:text-purple-400 cursor-pointer py-3 text-lg"
              @mouseover="handleMouseOver('/skills')" @mouseout="handleMouseOut('/skills')">Skills</a>
            <transition name="preview-fade">
              <div v-if="showPreviews['/skills']"
                class="absolute right-full top-0 mr-10 w-64 bg-gray-800 rounded-md shadow-lg z-50 overflow-hidden">
                <img src="public\img\menuhover\skills.png" alt="Vista previa Skills" class="rounded">
              </div>
            </transition>
          </div>
          ...
          <div class="relative">
            <a @click="navigateTo('/proyectos')"
              class="block text-white transition duration-500 font-medium hover:-translate-x-2 hover:text-purple-400 cursor-pointer py-3 text-lg"
              @mouseover="handleMouseOver('/proyectos')" @mouseout="handleMouseOut('/proyectos')">Proyectos</a>
            <transition name="preview-fade">
              <div v-if="showPreviews['/proyectos']"
                class="absolute right-full top-0 mr-10 w-64 bg-gray-800 rounded-md shadow-lg z-50 overflow-hidden">
                <img src="public\img\menuhover\proyectos.png" alt="Vista previa Proyectos" class="rounded">
              </div>
            </transition>
          </div>
          ...
          <div class="relative">
            <a @click="navigateTo('/estudios')"
              class="block text-white transition duration-500 font-medium hover:-translate-x-2 hover:text-purple-400 cursor-pointer py-3 text-lg"
              @mouseover="handleMouseOver('/estudios')" @mouseout="handleMouseOut('/estudios')">Estudios
              y Experiencia</a>
            <transition name="preview-fade">
              <div v-if="showPreviews['/estudios']"
                class="absolute right-full top-0 mr-10 w-64 bg-gray-800 rounded-md shadow-lg z-50 overflow-hidden">
                <img src="public\img\menuhover\estudios.png" alt="Vista previa Estudios y Experiencia" class="rounded">
              </div>
            </transition>
          </div>
          ...
          <div class="relative">
            <a @click="navigateTo('/contacto')"
              ...
              @mouseover="handleMouseOver('/contacto')" @mouseout="handleMouseOut('/contacto')">Contacto</a>
            <transition name="preview-fade">
              <div v-if="showPreviews['/contacto']"
                class="absolute right-full top-0 mr-10 w-64 bg-gray-800 rounded-md shadow-lg z-50 overflow-hidden">
                <img src="public\img\menuhover\contacto.png" alt="Vista previa Contacto" class="rounded">
              </div>
            </transition>
          </div>
        </div>
